...
<!-- jQuery sticky menu -->
<script src="<?php __DIR__?>/../ecommerce-php/resources/js/owl.carousel.min.js"></script>
<script src="<?php __DIR__?>/../ecommerce-php/resources/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="<?php __DIR__?>/../ecommerce-php/resources/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="<?php __DIR__?>/../ecommerce-php/resources/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="<?php __DIR__?>/../ecommerce-php/resources/js/bxslider.min.js"></script>
<script type="text/javascript" src="<?php __DIR__?>/../ecommerce-php/resources/js/script.slider.js"></script>
    </body>
</html>